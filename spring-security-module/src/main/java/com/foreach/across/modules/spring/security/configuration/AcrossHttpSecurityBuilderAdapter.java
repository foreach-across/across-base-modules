 ...
 * @since 1.0.3
 */
class AcrossHttpSecurityBuilderAdapter implements Ordered, SecurityBuilder<SecurityFilterChain>
{
	private final HttpSecurity httpSecurity;
	private final AcrossWebSecurityConfigurer configurer;
	private final int order;

	public AcrossHttpSecurityBuilderAdapter( HttpSecurity httpSecurity, AcrossWebSecurityConfigurer configurer, int order ) {
