...
@Slf4j
public class AcrossRepositoryConfigurationDelegate
{
	...
	private static final String NON_DEFAULT_AUTOWIRE_CANDIDATE_RESOLVER =
			"Non-default AutowireCandidateResolver (%s) detected. Skipping the registration of LazyRepositoryInjectionPointResolver. Lazy repository injection will not be working!";
	 ...
	 */
	public AcrossRepositoryConfigurationDelegate( RepositoryConfigurationSource configurationSource,
	...
	static class LazyRepositoryInjectionPointResolver extends ContextAnnotationAutowireCandidateResolver
	{
		...
		/**
		 * Returns a new {@link AcrossRepositoryConfigurationDelegate.LazyRepositoryInjectionPointResolver} that will have its configurations augmented with the
		 * given ones.
		 *
		 * @param configurations must not be {@literal null}.
		 * @return
		 */
		AcrossRepositoryConfigurationDelegate.LazyRepositoryInjectionPointResolver withAdditionalConfigurations(
			...
			return new AcrossRepositoryConfigurationDelegate.LazyRepositoryInjectionPointResolver( map );
		}
