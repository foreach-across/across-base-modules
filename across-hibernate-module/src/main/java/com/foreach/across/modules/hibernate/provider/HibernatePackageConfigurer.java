...
/**
 * Allows a {@link HibernatePackageRegistry} to be configured. Consuming modules should inject
 * an implementation into the Hibernate module using {@link ModuleConfiguration}.
...
public interface HibernatePackageConfigurer
{
	 ...
	 *
	 * @param hibernatePackage instance
	 */
