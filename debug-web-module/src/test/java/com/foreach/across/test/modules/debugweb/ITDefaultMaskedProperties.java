...
@DirtiesContext
@WebAppConfiguration
@ContextConfiguration(classes = ITDefaultMaskedProperties.Config.class)
@TestPropertySource(
		properties = {
...
public class ITDefaultMaskedProperties
{
	...
	@Test
	public void passwordPropertyShouldBeHidden() throws Exception {
		mockMvc.perform( get( PROPERTIES_URL ) )
		       .andExpect( content().string( containsString( "my.password.value" ) ) )
		       .andExpect( content().string( not( containsString( "passwordvalue" ) ) ) );
	}
	...
	@Test
	public void customPropertyShouldBeVisible() throws Exception {
		mockMvc.perform( get( PROPERTIES_URL ) )
		       .andExpect( content().string( containsString( "custom.property" ) ) )
		       .andExpect( content().string( containsString( "custom.value" ) ) );
	}
